...
namespace UnityEditor.Tilemaps
{
    ...
    public abstract class TilemapEditorTool : EditorTool
    {
        ...
        {
            var lastActiveToolType = ToolManager.activeToolType;
            if (IsCachedEditorToolsInvalid())
                InstantiateEditorTools();
            ...
            if (lastActiveToolType != null && lastActiveToolType.IsSubclassOf(typeof(TilemapEditorTool)))
            {
                TilemapEditorTool.SetActiveEditorTool(lastActiveToolType);
            }
        }
