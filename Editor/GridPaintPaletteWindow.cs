...
namespace UnityEditor.Tilemaps
{
    ...
    public class GridPaintPaletteWindow : EditorWindow, ISupportsOverlays
    {
        ...
        internal static class ShortcutIds
        {
            ...
            // Added
            public const string k_IncreaseZBy2 = "Grid Painting/Increase Z by 2";
            public const string k_DecreaseZ = "Grid Painting/Decrease Z";
            // Added
            public const string k_DecreaseZBy2 = "Grid Painting/Decrease Z by 2";
        ...
        // Changed to use control modifier
        [Shortcut(ShortcutIds.k_IncreaseZ, typeof(TilemapEditorTool.ShortcutContext), KeyCode.Minus, ShortcutModifiers.Control)]
        ...
        // Changed to use control modifier
        [Shortcut(ShortcutIds.k_DecreaseZ, typeof(TilemapEditorTool.ShortcutContext), KeyCode.Equals, ShortcutModifiers.Control)]
